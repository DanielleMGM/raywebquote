...
namespace DuoWebTests
{
    ...
    public class DuoWebTests
    {
        ...
        const string IKEY = "DIJQ1QIOX66I8TTOIIWQ";                         //"DIXXXXXXXXXXXXXXXXXX";
        const string WRONG_IKEY = "DIXXXXXXXXXXXXXXXXXY";
        const string SKEY = "t4X9wYHt9wYdnpA9c8eDlsytpy8IyWV58cia21Bs";     //"deadbeefdeadbeefdeadbeefdeadbeefdeadbeef";
        const string AKEY = "api-19435623.duosecurity.com";                 // "useacustomerprovidedapplicationsecretkey";

        /* Dummy username */
        const string USER = "Davis.DeBard@mgmtransformer.com";              //"testuser";
